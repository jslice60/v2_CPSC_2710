...
public class SeatReservation {
    ...
    // Constructor
    public SeatReservation(String flightDesignator, LocalDate flightDate, String firstName, String lastName, int numberOfBags, boolean flyingWithInfant) {
        this.flightDesignator = flightDesignator;
        this.flightDate = flightDate;
        this.firstName = firstName;
        this.lastName = lastName;
        this.numberOfBags = 0; // Default value
        this.flyingWithInfant = false; // Default value
    }
